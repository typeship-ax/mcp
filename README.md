...
> **Partial output.** This package covers the first 25 operations; 5 more in the spec were not generated by the operation cap on this run. `api.md` lists what is here.

## Install

```sh
npm install typeship-mcp
```
