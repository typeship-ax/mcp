...
const expected = {"output":"mcp","version":1,"members":[["generate","run"],["generate","downloadPackage"],["projects","list"],["projects","create"],["projects","retrieve"],["projects","delete"],["projects","update"],["projects","retrieveDiagnostics"],["projects","refreshDiagnostics"],["projects","remediateDiagnostics"],["projects","retrieveIntegrationHealth"],["projects","listGenerations"],["projects","generate"],["definitions","retrieve"],["definitions","update"],["targets","list"],["targets","create"],["targets","retrieve"],["targets","delete"],["targets","update"],["targets","listReleases"],["targets","retrieveDraft"],["targets","updateDraft"],["targets","adoptRelease"],["targets","retrieveRelease"],["targets","republishRelease"],["targets","listDraftFiles"],["targets","retrieveDraftFileContent"],["targets","resolveDraftConflicts"],["targets","discardDraftCustomizations"],["targets","recoverDraftHistory"],["targets","retrieveDelivery"],["targets","retrievePublication"],["generations","retrieve"],["generations","retrieveFile"],["definitionRevisions","list"],["definitionRevisions","retrieve"],["definitionRevisions","retrieveContent"],["definitionRevisions","retrieveDocumentContent"],["definitionRevisions","retrieveDocument"],["account","retrieve"],["apiKeys","list"],["apiKeys","retrieve"],["apiKeys","revoke"]],"clients":["TypeshipClient"],"goCommands":[],"operations":[{"tool":"generate_run"},{"tool":"generate_download_package"},{"tool":"projects_list"},{"tool":"projects_create"},{"tool":"projects_retrieve"},{"tool":"projects_delete"},{"tool":"projects_update"},{"tool":"projects_retrieve_diagnostics"},{"tool":"projects_refresh_diagnostics"},{"tool":"projects_remediate_diagnostics"},{"tool":"projects_retrieve_integration_health"},{"tool":"projects_list_generations"},{"tool":"projects_generate"},{"tool":"definitions_retrieve"},{"tool":"definitions_update"},{"tool":"targets_list"},{"tool":"targets_create"},{"tool":"targets_retrieve"},{"tool":"targets_delete"},{"tool":"targets_update"},{"tool":"targets_list_releases"},{"tool":"targets_retrieve_draft"},{"tool":"targets_update_draft"},{"tool":"targets_adopt_release"},{"tool":"targets_retrieve_release"},{"tool":"targets_republish_release"},{"tool":"targets_list_draft_files"},{"tool":"targets_retrieve_draft_file_content"},{"tool":"targets_resolve_draft_conflicts"},{"tool":"targets_discard_draft_customizations"},{"tool":"targets_recover_draft_history"},{"tool":"targets_retrieve_delivery"},{"tool":"targets_retrieve_publication"},{"tool":"generations_retrieve"},{"tool":"generations_retrieve_file"},{"tool":"definition_revisions_list"},{"tool":"definition_revisions_retrieve"},{"tool":"definition_revisions_retrieve_content"},{"tool":"definition_revisions_retrieve_document_content"},{"tool":"definition_revisions_retrieve_document"},{"tool":"account_retrieve"},{"tool":"api_keys_list"},{"tool":"api_keys_retrieve"},{"tool":"api_keys_revoke"}],"executableName":"typeship","toolMode":"meta","operationSpecs":[{"resource":"generate","method":"run","command":["generate","run"],"tool":"generate_run","httpMethod":"POST","path":"/generate"},{"resource":"generate","method":"downloadPackage","command":["generate","download-package"],"tool":"generate_download_package","httpMethod":"GET","path":"/generate/download"},{"resource":"projects","method":"list","command":["projects","list"],"tool":"projects_list","httpMethod":"GET","path":"/projects"},{"resource":"projects","method":"create","command":["projects","create"],"tool":"projects_create","httpMethod":"POST","path":"/projects"},{"resource":"projects","method":"retrieve","command":["projects","retrieve"],"tool":"projects_retrieve","httpMethod":"GET","path":"/projects/{project_id}"},{"resource":"projects","method":"delete","command":["projects","delete"],"tool":"projects_delete","httpMethod":"DELETE","path":"/projects/{project_id}"},{"resource":"projects","method":"update","command":["projects","update"],"tool":"projects_update","httpMethod":"PATCH","path":"/projects/{project_id}"},{"resource":"projects","method":"retrieveDiagnostics","command":["projects","retrieve-diagnostics"],"tool":"projects_retrieve_diagnostics","httpMethod":"GET","path":"/projects/{project_id}/diagnostics"},{"resource":"projects","method":"refreshDiagnostics","command":["projects","refresh-diagnostics"],"tool":"projects_refresh_diagnostics","httpMethod":"POST","path":"/projects/{project_id}/diagnostics"},{"resource":"projects","method":"remediateDiagnostics","command":["projects","remediate-diagnostics"],"tool":"projects_remediate_diagnostics","httpMethod":"POST","path":"/projects/{project_id}/diagnostics/remediations"},{"resource":"projects","method":"retrieveIntegrationHealth","command":["projects","retrieve-integration-health"],"tool":"projects_retrieve_integration_health","httpMethod":"GET","path":"/projects/{project_id}/integration-health"},{"resource":"projects","method":"listGenerations","command":["projects","list-generations"],"tool":"projects_list_generations","httpMethod":"GET","path":"/projects/{project_id}/generations"},{"resource":"projects","method":"generate","command":["projects","generate"],"tool":"projects_generate","httpMethod":"POST","path":"/projects/{project_id}/generations"},{"resource":"definitions","method":"retrieve","command":["definitions","retrieve"],"tool":"definitions_retrieve","httpMethod":"GET","path":"/definitions/{definition_id}"},{"resource":"definitions","method":"update","command":["definitions","update"],"tool":"definitions_update","httpMethod":"PATCH","path":"/definitions/{definition_id}"},{"resource":"targets","method":"list","command":["targets","list"],"tool":"targets_list","httpMethod":"GET","path":"/projects/{project_id}/targets"},{"resource":"targets","method":"create","command":["targets","create"],"tool":"targets_create","httpMethod":"POST","path":"/projects/{project_id}/targets"},{"resource":"targets","method":"retrieve","command":["targets","retrieve"],"tool":"targets_retrieve","httpMethod":"GET","path":"/targets/{target_id}"},{"resource":"targets","method":"delete","command":["targets","delete"],"tool":"targets_delete","httpMethod":"DELETE","path":"/targets/{target_id}"},{"resource":"targets","method":"update","command":["targets","update"],"tool":"targets_update","httpMethod":"PATCH","path":"/targets/{target_id}"},{"resource":"targets","method":"listReleases","command":["targets","list-releases"],"tool":"targets_list_releases","httpMethod":"GET","path":"/targets/{target_id}/releases"},{"resource":"targets","method":"retrieveDraft","command":["targets","retrieve-draft"],"tool":"targets_retrieve_draft","httpMethod":"GET","path":"/targets/{target_id}/draft"},{"resource":"targets","method":"updateDraft","command":["targets","update-draft"],"tool":"targets_update_draft","httpMethod":"PATCH","path":"/targets/{target_id}/draft"},{"resource":"targets","method":"adoptRelease","command":["targets","adopt-release"],"tool":"targets_adopt_release","httpMethod":"POST","path":"/targets/{target_id}/adopt"},{"resource":"targets","method":"retrieveRelease","command":["targets","retrieve-release"],"tool":"targets_retrieve_release","httpMethod":"GET","path":"/target-releases/{target_release_id}"},{"resource":"targets","method":"republishRelease","command":["targets","republish-release"],"tool":"targets_republish_release","httpMethod":"POST","path":"/target-releases/{target_release_id}/republish"},{"resource":"targets","method":"listDraftFiles","command":["targets","list-draft-files"],"tool":"targets_list_draft_files","httpMethod":"GET","path":"/targets/{target_id}/draft/files"},{"resource":"targets","method":"retrieveDraftFileContent","command":["targets","retrieve-draft-file-content"],"tool":"targets_retrieve_draft_file_content","httpMethod":"GET","path":"/targets/{target_id}/draft/files/content"},{"resource":"targets","method":"resolveDraftConflicts","command":["targets","resolve-draft-conflicts"],"tool":"targets_resolve_draft_conflicts","httpMethod":"POST","path":"/targets/{target_id}/draft/conflicts/resolve"},{"resource":"targets","method":"discardDraftCustomizations","command":["targets","discard-draft-customizations"],"tool":"targets_discard_draft_customizations","httpMethod":"POST","path":"/targets/{target_id}/draft/customizations/discard"},{"resource":"targets","method":"recoverDraftHistory","command":["targets","recover-draft-history"],"tool":"targets_recover_draft_history","httpMethod":"POST","path":"/targets/{target_id}/draft/history/recover"},{"resource":"targets","method":"retrieveDelivery","command":["targets","retrieve-delivery"],"tool":"targets_retrieve_delivery","httpMethod":"GET","path":"/deliveries/{delivery_id}"},{"resource":"targets","method":"retrievePublication","command":["targets","retrieve-publication"],"tool":"targets_retrieve_publication","httpMethod":"GET","path":"/publications/{publication_id}"},{"resource":"generations","method":"retrieve","command":["generations","retrieve"],"tool":"generations_retrieve","httpMethod":"GET","path":"/generations/{generation_id}"},{"resource":"generations","method":"retrieveFile","command":["generations","retrieve-file"],"tool":"generations_retrieve_file","httpMethod":"GET","path":"/generations/{generation_id}/file"},{"resource":"definitionRevisions","method":"list","command":["definition-revisions","list"],"tool":"definition_revisions_list","httpMethod":"GET","path":"/definitions/{definition_id}/revisions"},{"resource":"definitionRevisions","method":"retrieve","command":["definition-revisions","retrieve"],"tool":"definition_revisions_retrieve","httpMethod":"GET","path":"/definition-revisions/{definition_revision_id}"},{"resource":"definitionRevisions","method":"retrieveContent","command":["definition-revisions","retrieve-content"],"tool":"definition_revisions_retrieve_content","httpMethod":"GET","path":"/definition-revisions/{definition_revision_id}/content"},{"resource":"definitionRevisions","method":"retrieveDocumentContent","command":["definition-revisions","retrieve-document-content"],"tool":"definition_revisions_retrieve_document_content","httpMethod":"GET","path":"/definition-revisions/{definition_revision_id}/documents/{document_id}/content"},{"resource":"definitionRevisions","method":"retrieveDocument","command":["definition-revisions","retrieve-document"],"tool":"definition_revisions_retrieve_document","httpMethod":"GET","path":"/definition-documents/{definition_document_id}"},{"resource":"account","method":"retrieve","command":["account","retrieve"],"tool":"account_retrieve","httpMethod":"GET","path":"/me"},{"resource":"apiKeys","method":"list","command":["api-keys","list"],"tool":"api_keys_list","httpMethod":"GET","path":"/api-keys"},{"resource":"apiKeys","method":"retrieve","command":["api-keys","retrieve"],"tool":"api_keys_retrieve","httpMethod":"GET","path":"/api-keys/{api_key_id}"},{"resource":"apiKeys","method":"revoke","command":["api-keys","revoke"],"tool":"api_keys_revoke","httpMethod":"DELETE","path":"/api-keys/{api_key_id}"}]};
