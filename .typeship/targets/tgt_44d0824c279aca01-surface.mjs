...
const expected = {"output":"mcp","version":1,"members":[["generate","run"],["generate","downloadPackage"],["projects","list"],["projects","create"],["projects","get"],["projects","delete"],["projects","update"],["projects","generate"],["specs","get"],["specs","update"],["specs","refresh"],["specRevisions","list"],["specRevisions","get"],["specRevisions","listFiles"],["targets","list"],["targets","create"],["targets","get"],["targets","delete"],["targets","update"],["targets","adopt"],["drafts","list"],["drafts","get"],["drafts","update"],["drafts","listFiles"],["drafts","resolve"],["drafts","recover"],["releases","list"],["releases","get"],["releases","retry"],["deliveries","list"],["deliveries","create"],["deliveries","get"],["deliveries","delete"],["deliveries","update"],["publications","list"],["publications","get"],["generations","list"],["generations","get"],["generations","listFiles"],["files","get"],["organization","get"],["apiKeys","list"],["apiKeys","get"],["apiKeys","revoke"]],"clients":["TypeshipClient"],"goCommands":[],"operations":[{"tool":"generate_run"},{"tool":"generate_download_package"},{"tool":"projects_list"},{"tool":"projects_create"},{"tool":"projects_get"},{"tool":"projects_delete"},{"tool":"projects_update"},{"tool":"projects_generate"},{"tool":"specs_get"},{"tool":"specs_update"},{"tool":"specs_refresh"},{"tool":"spec_revisions_list"},{"tool":"spec_revisions_get"},{"tool":"spec_revisions_list_files"},{"tool":"targets_list"},{"tool":"targets_create"},{"tool":"targets_get"},{"tool":"targets_delete"},{"tool":"targets_update"},{"tool":"targets_adopt"},{"tool":"drafts_list"},{"tool":"drafts_get"},{"tool":"drafts_update"},{"tool":"drafts_list_files"},{"tool":"drafts_resolve"},{"tool":"drafts_recover"},{"tool":"releases_list"},{"tool":"releases_get"},{"tool":"releases_retry"},{"tool":"deliveries_list"},{"tool":"deliveries_create"},{"tool":"deliveries_get"},{"tool":"deliveries_delete"},{"tool":"deliveries_update"},{"tool":"publications_list"},{"tool":"publications_get"},{"tool":"generations_list"},{"tool":"generations_get"},{"tool":"generations_list_files"},{"tool":"files_get"},{"tool":"organization_get"},{"tool":"api_keys_list"},{"tool":"api_keys_get"},{"tool":"api_keys_revoke"}],"executableName":"typeship","toolMode":"meta","operationSpecs":[{"resource":"generate","method":"run","command":["generate","run"],"tool":"generate_run","httpMethod":"POST","path":"/generate"},{"resource":"generate","method":"downloadPackage","command":["generate","download-package"],"tool":"generate_download_package","httpMethod":"GET","path":"/generate/download"},{"resource":"projects","method":"list","command":["projects","list"],"tool":"projects_list","httpMethod":"GET","path":"/projects"},{"resource":"projects","method":"create","command":["projects","create"],"tool":"projects_create","httpMethod":"POST","path":"/projects"},{"resource":"projects","method":"get","command":["projects","get"],"tool":"projects_get","httpMethod":"GET","path":"/projects/{project_id}"},{"resource":"projects","method":"delete","command":["projects","delete"],"tool":"projects_delete","httpMethod":"DELETE","path":"/projects/{project_id}"},{"resource":"projects","method":"update","command":["projects","update"],"tool":"projects_update","httpMethod":"PATCH","path":"/projects/{project_id}"},{"resource":"projects","method":"generate","command":["projects","generate"],"tool":"projects_generate","httpMethod":"POST","path":"/projects/{project_id}/generate"},{"resource":"specs","method":"get","command":["specs","get"],"tool":"specs_get","httpMethod":"GET","path":"/specs/{spec_id}"},{"resource":"specs","method":"update","command":["specs","update"],"tool":"specs_update","httpMethod":"PATCH","path":"/specs/{spec_id}"},{"resource":"specs","method":"refresh","command":["specs","refresh"],"tool":"specs_refresh","httpMethod":"POST","path":"/specs/{spec_id}/refresh"},{"resource":"specRevisions","method":"list","command":["spec-revisions","list"],"tool":"spec_revisions_list","httpMethod":"GET","path":"/spec-revisions"},{"resource":"specRevisions","method":"get","command":["spec-revisions","get"],"tool":"spec_revisions_get","httpMethod":"GET","path":"/spec-revisions/{spec_revision_id}"},{"resource":"specRevisions","method":"listFiles","command":["spec-revisions","list-files"],"tool":"spec_revisions_list_files","httpMethod":"GET","path":"/spec-revisions/{spec_revision_id}/files"},{"resource":"targets","method":"list","command":["targets","list"],"tool":"targets_list","httpMethod":"GET","path":"/targets"},{"resource":"targets","method":"create","command":["targets","create"],"tool":"targets_create","httpMethod":"POST","path":"/targets"},{"resource":"targets","method":"get","command":["targets","get"],"tool":"targets_get","httpMethod":"GET","path":"/targets/{target_id}"},{"resource":"targets","method":"delete","command":["targets","delete"],"tool":"targets_delete","httpMethod":"DELETE","path":"/targets/{target_id}"},{"resource":"targets","method":"update","command":["targets","update"],"tool":"targets_update","httpMethod":"PATCH","path":"/targets/{target_id}"},{"resource":"targets","method":"adopt","command":["targets","adopt"],"tool":"targets_adopt","httpMethod":"POST","path":"/targets/{target_id}/adopt"},{"resource":"drafts","method":"list","command":["drafts","list"],"tool":"drafts_list","httpMethod":"GET","path":"/drafts"},{"resource":"drafts","method":"get","command":["drafts","get"],"tool":"drafts_get","httpMethod":"GET","path":"/drafts/{draft_id}"},{"resource":"drafts","method":"update","command":["drafts","update"],"tool":"drafts_update","httpMethod":"PATCH","path":"/drafts/{draft_id}"},{"resource":"drafts","method":"listFiles","command":["drafts","list-files"],"tool":"drafts_list_files","httpMethod":"GET","path":"/drafts/{draft_id}/files"},{"resource":"drafts","method":"resolve","command":["drafts","resolve"],"tool":"drafts_resolve","httpMethod":"POST","path":"/drafts/{draft_id}/resolve"},{"resource":"drafts","method":"recover","command":["drafts","recover"],"tool":"drafts_recover","httpMethod":"POST","path":"/drafts/{draft_id}/recover"},{"resource":"releases","method":"list","command":["releases","list"],"tool":"releases_list","httpMethod":"GET","path":"/releases"},{"resource":"releases","method":"get","command":["releases","get"],"tool":"releases_get","httpMethod":"GET","path":"/releases/{release_id}"},{"resource":"releases","method":"retry","command":["releases","retry"],"tool":"releases_retry","httpMethod":"POST","path":"/releases/{release_id}/retry"},{"resource":"deliveries","method":"list","command":["deliveries","list"],"tool":"deliveries_list","httpMethod":"GET","path":"/deliveries"},{"resource":"deliveries","method":"create","command":["deliveries","create"],"tool":"deliveries_create","httpMethod":"POST","path":"/deliveries"},{"resource":"deliveries","method":"get","command":["deliveries","get"],"tool":"deliveries_get","httpMethod":"GET","path":"/deliveries/{delivery_id}"},{"resource":"deliveries","method":"delete","command":["deliveries","delete"],"tool":"deliveries_delete","httpMethod":"DELETE","path":"/deliveries/{delivery_id}"},{"resource":"deliveries","method":"update","command":["deliveries","update"],"tool":"deliveries_update","httpMethod":"PATCH","path":"/deliveries/{delivery_id}"},{"resource":"publications","method":"list","command":["publications","list"],"tool":"publications_list","httpMethod":"GET","path":"/publications"},{"resource":"publications","method":"get","command":["publications","get"],"tool":"publications_get","httpMethod":"GET","path":"/publications/{publication_id}"},{"resource":"generations","method":"list","command":["generations","list"],"tool":"generations_list","httpMethod":"GET","path":"/generations"},{"resource":"generations","method":"get","command":["generations","get"],"tool":"generations_get","httpMethod":"GET","path":"/generations/{generation_id}"},{"resource":"generations","method":"listFiles","command":["generations","list-files"],"tool":"generations_list_files","httpMethod":"GET","path":"/generations/{generation_id}/files"},{"resource":"files","method":"get","command":["files","get"],"tool":"files_get","httpMethod":"GET","path":"/files/{file_id}"},{"resource":"organization","method":"get","command":["organization","get"],"tool":"organization_get","httpMethod":"GET","path":"/organization"},{"resource":"apiKeys","method":"list","command":["api-keys","list"],"tool":"api_keys_list","httpMethod":"GET","path":"/api-keys"},{"resource":"apiKeys","method":"get","command":["api-keys","get"],"tool":"api_keys_get","httpMethod":"GET","path":"/api-keys/{api_key_id}"},{"resource":"apiKeys","method":"revoke","command":["api-keys","revoke"],"tool":"api_keys_revoke","httpMethod":"DELETE","path":"/api-keys/{api_key_id}"}]};
